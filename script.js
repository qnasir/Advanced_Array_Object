...
const five = strings.filter(function (item) {
...
const kalvium = alphabets.reduce(function (result, item) {
  return result + '' +item;
})
console.log(kalvium)
...
const even = number.find(function (item) {
  return item % 2 == 0
})
console.log(even)
...
const index = ranks.findIndex(function(item) {
  return item == 7;
})
console.log(index)
...
const check_positive = positive.every(function(item) {
  return item > 0;
})
console.log(check_positive)
...
console.log(person.email="ajaykumar@gmail.com")
